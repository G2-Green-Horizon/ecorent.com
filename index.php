...
<body id="homepage">
    ...
    <section class="container my-3">
        <div class="row justify-content-center g-3">
            ...
            <a href="listings.php?setCategory=2" class="capsule col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="d-flex align-items-center p-3 rounded-pill" style="background-color: #343333;">
            ...
            <a href="listings.php?setCategory=3" class="capsule col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="d-flex align-items-center p-3 rounded-pill" style="background-color: #343333;">
            ...
            <a href="listings.php?setCategory=1" class="capsule col-12 col-sm-6 col-md-6 col-lg-3">
                <div class="d-flex align-items-center p-3 rounded-pill" style="background-color: #343333;">
            ...
            <a href="listings.php?setCategory=4" class="capsule col-12 col-sm-6 col-md-6 col-lg-3">
                <div class="d-flex align-items-center p-3 rounded-pill" style="background-color: #343333;">
